...
public:
  ...
  enum TypeID {
    ...
    Float4TyID,      ///<  1: 4-bit floating point type
    Float8TyID,      ///<  2: 8-bit floating point type
...
public:
  ...
  bool isFloat4Ty() const { return getTypeID() == Float4TyID; }
  bool isFloat8Ty() const { return getTypeID() == Float8TyID; }
  ...
  bool isFloatingPointTy() const {
    return getTypeID() == Float4TyID || getTypeID() == Float8TyID ||
  ...
  const fltSemantics &getFltSemantics() const {
    switch (getTypeID()) {
    case Float4TyID: return APFloat::IEEEfloat4();
    case Float8TyID: return APFloat::IEEEfloat8();
  ...
  static Type *getFloat4Ty(LLVMContext &C);
  static Type *getFloat8Ty(LLVMContext &C);
  ...
  // types as pointee.
  //
  static PointerType *getFloat4PtrTy(LLVMContext &C, unsigned AS = 0);
  static PointerType *getFloat8PtrTy(LLVMContext &C, unsigned AS = 0);
