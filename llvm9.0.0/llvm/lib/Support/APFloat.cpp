...
namespace llvm {
  ...
  static const fltSemantics semIEEEfloat4 = {3, -2, 2, 4};
  static const fltSemantics semIEEEfloat8 = {7, -6, 5, 8};
  ...
  APFloatBase::SemanticsToEnum(const llvm::fltSemantics &Sem) {
    if (&Sem == &llvm::APFloat::IEEEfloat4())
      return S_IEEEfloat4;
    else if (&Sem == &llvm::APFloat::IEEEfloat8())
      return S_IEEEfloat8;
  ...
  const fltSemantics &APFloatBase::IEEEfloat4() {
    return semIEEEfloat4;
  }
  const fltSemantics &APFloatBase::IEEEfloat8() {
    return semIEEEfloat8;
  }
...
APInt IEEEFloat::convertFloat4APFloatToAPInt() const {
  assert(semantics == (const llvm::fltSemantics*)&semIEEEfloat4);
  assert(partCount()==1);
...
APInt IEEEFloat::convertFloat8APFloatToAPInt() const {
  assert(semantics == (const llvm::fltSemantics*)&semIEEEfloat8);
  assert(partCount()==1);
...
APInt IEEEFloat::bitcastToAPInt() const {
  if (semantics == (const llvm::fltSemantics*)&semIEEEfloat4)
    return convertFloat4APFloatToAPInt();

  if (semantics == (const llvm::fltSemantics*)&semIEEEfloat8)
    return convertFloat8APFloatToAPInt();
...
void IEEEFloat::initFromAPInt(const fltSemantics *Sem, const APInt &api) {
  if (Sem == &semIEEEfloat4)
    return initFromFloat4APInt(api);
  if (Sem == &semIEEEfloat8)
    return initFromFloat8APInt(api);
  if (Sem == &semIEEEhalf)
...
APFloat APFloat::getAllOnesValue(unsigned BitWidth, bool isIEEE) {
  if (isIEEE) {
    switch (BitWidth) {
    case 4:
      return APFloat(semIEEEfloat4, APInt::getAllOnesValue(BitWidth));
    case 8:
      return APFloat(semIEEEfloat8, APInt::getAllOnesValue(BitWidth));
    case 16:
