...
Type *EVT::getTypeForEVT(LLVMContext &Context) const {
  ...
  case MVT::f4:      return Type::getFloat4Ty(Context);
  case MVT::f8:      return Type::getFloat8Ty(Context);
...
MVT MVT::getVT(Type *Ty, bool HandleUnknown){
  ...
  case Type::Float4TyID:    return MVT(MVT::f4);
  case Type::Float8TyID:    return MVT(MVT::f8);
