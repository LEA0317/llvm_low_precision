...
LLVMTypeKind LLVMGetTypeKind(LLVMTypeRef Ty) {
  ...
  case Type::Float4TyID:
    return LLVMFloat4TypeKind;
  case Type::Float8TyID:
    return LLVMFloat8TypeKind;
  case Type::HalfTyID:
...
LLVMTypeRef KLVMInt256TypeInContext(LLVMContextRef C) {
...
LLVMTypeRef LLVMFloat4TypeInContext(LLVMContextRef C) {
  return (LLVMTypeRef) Type::getFloat4Ty(*unwrap(C));
}
LLVMTypeRef LLVMFloat8TypeInContext(LLVMContextRef C) {
  return (LLVMTypeRef) Type::getFloat8Ty(*unwrap(C));
}
...
LLVMTypeRef LLVMFloat4Type(void) {
  return LLVMFloat4TypeInContext(LLVMGetGlobalContext());
}
LLVMTypeRef LLVMFloat8Type(void) {
  return LLVMFloat8TypeInContext(LLVMGetGlobalContext());
}
