...
void ASTContext::InitBuiltinTypes(const TargetInfo &Target,
  ...
  InitBuiltinType(Int256Ty,            BuiltinType::SInt256);
...
#include "clang/Basic/OpenCLExtensionTypes.def"
  ...
  InitBuiltinType(Float8Ty,            BuiltinType::Float8);
...
const llvm::fltSemantics &ASTContext::getFloatTypeSemantics(QualType T) const {
  ...
  case BuiltinType::Float4:
    return Target->getFloat4Format();
  case BuiltinType::Float8:
    return Target->getFloat8Format();
...
#include "clang/AST/TypeNodes.def"
  ...
  case Type::Builtin:
    ...
    case BuiltinType::SatULongFract:
      ...
      break;
    case BuiltinType::Float4:
      Width = Target->getFloat4Width();
      Align = Target->getFloat4Align();
      break;
    case BuiltinType::Float8:
...
static FloatingRank getFloatingRank(QualType T) {
  ...
  case BuiltinType::Float4:     return Float4Rank;
  case BuiltinType::Float8:     return Float8Rank;
...
QualType ASTContext::getFloatingTypeOfSizeWithinDomain(QualType Size,
  ...
  if (Domain->isComplexType()) {
    switch (EltRank) {
    case Float16Rank:
    case Float4Rank: llvm_unreachable("Complex f4 is not supported");
    case Float8Rank: llvm_unreachable("Complex f8 is not supported");
  ...
  switch (EltRank) {
  case Float4Rank:     return Float4Ty;
  case Float8Rank:     return Float8Ty;
...
static QualType DecodeTypeFromStr(const char *&Str, const ASTContext &Context,
  ...
  case 'o': // FIXME?
    ...
    Type = Context.Float4Ty;
    break;
  case 'O': // FIXME?
    assert(HowLong == 0 && !Signed && !Unsigned &&
           "Bad modifiers used with 'O'!");
    Type = Context.Float8Ty;
    break;
  case 'h':
    assert(HowLong == 0 && !Signed && !Unsigned &&
...
QualType ASTContext::getRealTypeForBitwidth(unsigned DestWidth) const {
  ...
  switch (Ty) {
  case TargetInfo::Float4:
    return Float4Ty;
  case TargetInfo::Float8:
    return Float8Ty;
