...
struct TransferrableTargetInfo {
  ...
  unsigned char Float4Width, Float4Align;
  ...
  const llvm::fltSemantics *HalfFormat, *FloatFormat, *DoubleFormat,
    *LongDoubleFormat, *Float128Format, *Float4Format, *Float8Format;
...
public:
  ...
  unsigned getInt4Width() const { return 4; } // FIXME
  unsigned getInt4Align() const { return 8; } // FIXME

  unsigned getInt256Width() const { return 256; }
  unsigned getInt256Align() const { return 256; }
  ...
  unsigned getFloat4Width() const { return Float4Width; }
  unsigned getFloat4Align() const { return Float4Align; }
  const llvm::fltSemantics &getFloat4Format() const { return *Float4Format; }
  unsigned getFloat8Width() const { return Float8Width; }
  unsigned getFloat8Align() const { return Float8Align; }
  const llvm::fltSemantics &getFloat8Format() const { return *Float8Format; }
