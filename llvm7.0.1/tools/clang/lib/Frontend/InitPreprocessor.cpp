...
/// specified FP model.
template <typename T>
static T PickFP(const llvm::fltSemantics *Sem, /*T IEEEFixed4Val, T IEEEFixed8Val, */ // LMSDK 
		T IEEEHalfVal, T IEEESingleVal,
                T IEEEDoubleVal, T X87DoubleExtendedVal, T PPCDoubleDoubleVal,
                T IEEEQuadVal) {
  if (Sem == (const llvm::fltSemantics*)&llvm::APFloat::IEEEfixed4()) // LMSDK FIX ME
    return IEEEHalfVal;
  if (Sem == (const llvm::fltSemantics*)&llvm::APFloat::IEEEfixed8()) // LMSDK FIX ME
    return IEEEHalfVal;
