...
static const SimpleTypeEntry SimpleTypeNames[] = {
    ...
    {"signed int4*", SimpleTypeKind::SInt4},
    {"unsigned int4*", SimpleTypeKind::UInt4},
    ...
    {"__int4*", SimpleTypeKind::SInt4},
    {"unsigned __int4*", SimpleTypeKind::UInt4},
    ...
    {"__int256*", SimpleTypeKind::SInt256},
    {"unsigned __int256*", SimpleTypeKind::UInt256},
    {"__fixed4*", SimpleTypeKind::Fixed4},
    {"__fixed8*", SimpleTypeKind::Fixed8},
