...
namespace llvm {
  ...
  static const fltSemantics semIEEEfixed4 = {3, -2, 2, 4};
  static const fltSemantics semIEEEfixed8 = {7, -6, 5, 8};
  ...
  const fltSemantics &APFloatBase::IEEEfixed4() {
    return semIEEEfixed4;
  }
  const fltSemantics &APFloatBase::IEEEfixed8() {
...
APInt IEEEFloat::bitcastToAPInt() const {
  if (semantics == (const llvm::fltSemantics*)&semIEEEfixed4)
    return convertFixed4APFloatToAPInt();

  if (semantics == (const llvm::fltSemantics*)&semIEEEfixed8)
...
void IEEEFloat::initFromAPInt(const fltSemantics *Sem, const APInt &api) {
  if (Sem == &semIEEEfixed4)
    return initFromFixed4APInt(api);
  if (Sem == &semIEEEfixed8)
