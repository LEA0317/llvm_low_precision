...
bool LLParser::ConvertValIDToValue(Type *Ty, ValID &ID, Value *&V,
  ...
  case ValID::t_APFloat:
    ...
    if (&ID.APFloatVal.getSemantics() == &APFloat::IEEEdouble()) {
      bool Ignored;
      if (Ty->isFloat4Ty())
        ID.APFloatVal.convert(APFloat::IEEEfloat4(), APFloat::rmNearestTiesToEven,
                              &Ignored);
      else if (Ty->isFloat8Ty())
        ID.APFloatVal.convert(APFloat::IEEEfloat8(), APFloat::rmNearestTiesToEven,
                              &Ignored);
      else if (Ty->isHalfTy())
