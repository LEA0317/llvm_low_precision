...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  case Builtin::BI__builtin_store_float4:
  case Builtin::BI__builtin_store_float4f: {
    Value *Val = EmitScalarExpr(E->getArg(0));
    Address Address = EmitPointerWithAlignment(E->getArg(1));
    Value *Float4Val = Builder.CreateFPTrunc(Val, Builder.getFloat4Ty());
    return RValue::get(Builder.CreateStore(Float4Val, Address));
  }
  case Builtin::BI__builtin_load_float4: {
    Address Address = EmitPointerWithAlignment(E->getArg(0));
    Value *Float4Val = Builder.CreateLoad(Address);
    return RValue::get(Builder.CreateFPExt(Float4Val, Builder.getDoubleTy()));
  }
  case Builtin::BI__builtin_load_float4f: {
    Address Address = EmitPointerWithAlignment(E->getArg(0));
    Value *Float4Val = Builder.CreateLoad(Address);
    return RValue::get(Builder.CreateFPExt(Float4Val, Builder.getFloatTy()));
  }
  case Builtin::BI__builtin_store_float8:
  case Builtin::BI__builtin_store_float8f: {
    Value *Val = EmitScalarExpr(E->getArg(0));
    Address Address = EmitPointerWithAlignment(E->getArg(1));
    Value *Float8Val = Builder.CreateFPTrunc(Val, Builder.getFloat4Ty());
    return RValue::get(Builder.CreateStore(Float8Val, Address));
  }
  case Builtin::BI__builtin_load_float8: {
    Address Address = EmitPointerWithAlignment(E->getArg(0));
    Value *Float8Val = Builder.CreateLoad(Address);
    return RValue::get(Builder.CreateFPExt(Float8Val, Builder.getDoubleTy()));
  }
  case Builtin::BI__builtin_load_float8f: {
    Address Address = EmitPointerWithAlignment(E->getArg(0));
    Value *Float8Val = Builder.CreateLoad(Address);
    return RValue::get(Builder.CreateFPExt(Float8Val, Builder.getFloatTy()));
  }
