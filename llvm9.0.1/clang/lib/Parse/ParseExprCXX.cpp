...
void Parser::ParseCXXSimpleTypeSpecifier(DeclSpec &DS) {
  ...
  case tok::kw___int128:
    ...
    break;
  case tok::kw_int4:
    DS.SetTypeSpecType(DeclSpec::TST_int4, Loc, PrevSpec, DiagID, Policy);
    break;
  case tok::kw_int256_t:
    DS.SetTypeSpecType(DeclSpec::TST_int256, Loc, PrevSpec, DiagID, Policy);
    break;
  case tok::kw_float4:
    DS.SetTypeSpecType(DeclSpec::TST_float4, Loc, PrevSpec, DiagID, Policy);
    break;
  case tok::kw_float8:
    DS.SetTypeSpecType(DeclSpec::TST_float8, Loc, PrevSpec, DiagID, Policy);
    break;
  case tok::kw_half:
