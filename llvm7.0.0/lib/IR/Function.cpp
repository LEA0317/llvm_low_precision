...
static std::string getMangledTypeStr(Type* Ty) {
  ...
  if (PointerType* PTyp = dyn_cast<PointerType>(Ty)) {
    ...
    case Type::Fixed4TyID:    Result += "f4";       break; // LMSDK
    case Type::Fixed8TyID:    Result += "f8";       break; // LMSDK      
...
static Type *DecodeFixedType(ArrayRef<Intrinsic::IITDescriptor> &Infos,
  ...
  case IITDescriptor::Fixed4: return Type::getFixed4Ty(Context); // LMSDK
  case IITDescriptor::Fixed8: return Type::getFixed8Ty(Context); // LMSDK
...
bool Intrinsic::matchIntrinsicType(Type *Ty, ArrayRef<Intrinsic::IITDescriptor> &Infos,
  ...
  switch (D.Kind) {
    ...
    case IITDescriptor::Fixed4: return !Ty->isFixed4Ty(); // LMSDK
    case IITDescriptor::Fixed8: return !Ty->isFixed8Ty(); // LMSDK      
