...
static llvm::Type *getTypeForFormat(llvm::LLVMContext &VMContext,
  ...
  if (&format == &llvm::APFloat::IEEEfloat4())
    return llvm::Type::getFloat4Ty(VMContext);
  if (&format == &llvm::APFloat::IEEEfloat8())
    return llvm::Type::getFloat8Ty(VMContext);
    ...
    case BuiltinType::Float4:
      ResultType =
          getTypeForFormat(getLLVMContext(), Context.getFloatTypeSemantics(T),
                           /* UseNativeFloat4 = */ true);
      break;
    case BuiltinType::Float8:
      ResultType =
          getTypeForFormat(getLLVMContext(), Context.getFloatTypeSemantics(T),
                           /* UseNativeFloat8 = */ true);
      break;
