...
/// specified FP model.
template <typename T>
static T PickFP(const llvm::fltSemantics *Sem, /*T IEEEFloat4Val, T IEEEFloat8Val*/
		T IEEEHalfVal, T IEEESingleVal,
                T IEEEDoubleVal, T X87DoubleExtendedVal, T PPCDoubleDoubleVal,
                T IEEEQuadVal) {
  if (Sem == (const llvm::fltSemantics*)&llvm::APFloat::IEEEfloat4())
    return IEEEHalfVal; // FIXME
  if (Sem == (const llvm::fltSemantics*)&llvm::APFloat::IEEEfloat8())
    return IEEEHalfVal; // FIXME
