...
struct APFloatBase {
  ...
  static const fltSemantics &IEEEfloat4() LLVM_READNONE;
  static const fltSemantics &IEEEfloat8() LLVM_READNONE;
...
private:
  ...
  APInt convertFloat4APFloatToAPInt() const;
  APInt convertFloat8APFloatToAPInt() const;
  ...
  void initFromFloat4APInt(const APInt &api);
  void initFromFloat8APInt(const APInt &api);
