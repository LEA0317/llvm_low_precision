...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      i4             =   3,   // This is a 4 bit integer value
      i8             =   4,   // This is an 8 bit integer value
      i16            =   5,   // This is a 16 bit integer value
      ...
      f4             =  10,   // This is a 4 bit floating point value
      f8             =  11,   // This is an 8 bit floating point value
      ...
      v32f32         =  81,   //   32 x f32
      v64f32         =  82,   //   64 x f32
      v128f32        =  83,   //  128 x f32
      v256f32        =  84,   //  256 x f32
      v512f32        =  85,   //  512 x f32
      v1024f32       =  86,   // 1024 x f32
      v2048f32       =  87,   // 2048 x f32
      v1f64          =  88,   //    1 x f64
      v2f64          =  89,   //    2 x f64
      v4f64          =  90,   //    4 x f64
      v8f64          =  91,   //    8 x f64
      ...
      nxv1i1         =  92,   // n x  1 x i1
      nxv2i1         =  93,   // n x  2 x i1
      nxv4i1         =  94,   // n x  4 x i1
      nxv8i1         =  95,   // n x  8 x i1
      nxv16i1        =  96,   // n x 16 x i1
      nxv32i1        =  97,   // n x 32 x i1

      nxv1i8         =  98,   // n x  1 x i8
      nxv2i8         =  99,   // n x  2 x i8
      nxv4i8         = 100,   // n x  4 x i8
      nxv8i8         = 101,   // n x  8 x i8
      nxv16i8        = 102,   // n x 16 x i8
      nxv32i8        = 103,   // n x 32 x i8

      nxv1i16        =  104,  // n x  1 x i16
      nxv2i16        =  105,  // n x  2 x i16
      nxv4i16        =  106,  // n x  4 x i16
      nxv8i16        =  107,  // n x  8 x i16
      nxv16i16       =  108,  // n x 16 x i16
      nxv32i16       =  109,  // n x 32 x i16

      nxv1i32        =  110,  // n x  1 x i32
      nxv2i32        =  111,  // n x  2 x i32
      nxv4i32        =  112,  // n x  4 x i32
      nxv8i32        =  113,  // n x  8 x i32
      nxv16i32       =  114,  // n x 16 x i32
      nxv32i32       =  115,  // n x 32 x i32

      nxv1i64        =  116,  // n x  1 x i64
      nxv2i64        =  117,  // n x  2 x i64
      nxv4i64        =  118,  // n x  4 x i64
      nxv8i64        =  119,  // n x  8 x i64
      nxv16i64       =  120,  // n x 16 x i64
      nxv32i64       =  121,  // n x 32 x i64
