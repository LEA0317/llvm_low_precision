...
static std::string getMangledTypeStr(Type* Ty) {
  ...
  if (PointerType* PTyp = dyn_cast<PointerType>(Ty)) {
    ...
    case Type::Float4TyID:    Result += "f4";       break;
    case Type::Float8TyID:    Result += "f8";       break;
...
static void DecodeIITType(unsigned &NextElt, ArrayRef<unsigned char> Infos,
  ...
  case IIT_METADATA:
    ...
    return;
  case IIT_F4:
    OutputTable.push_back(IITDescriptor::get(IITDescriptor::Float4, 0));
    return;
  case IIT_F8:
    OutputTable.push_back(IITDescriptor::get(IITDescriptor::Float8, 0));
    return;
  case IIT_F16:
...
static Type *DecodeFixedType(ArrayRef<Intrinsic::IITDescriptor> &Infos,
  ...
  case IITDescriptor::Float4: return Type::getFloat4Ty(Context);
  case IITDescriptor::Float8: return Type::getFloat8Ty(Context);
...
static bool matchIntrinsicType(
  ...
  switch (D.Kind) {
    ...
    case IITDescriptor::Float4: return !Ty->isFloat4Ty();
    case IITDescriptor::Float8: return !Ty->isFloat8Ty();
