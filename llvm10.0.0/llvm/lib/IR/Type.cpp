...
Type *Type::getPrimitiveType(LLVMContext &C, TypeID IDNumber) {
  ...
  case Float4TyID    : return getFloat4Ty(C);
  case Float8TyID    : return getFloat8Ty(C);
...
TypeSize Type::getPrimitiveSizeInBits() const {
  switch (getTypeID()) {
  case Type::Float4TyID: return TypeSize::Fixed(4);
  case Type::Float8TyID: return TypeSize::Fixed(8);
...
int Type::getFPMantissaWidth() const {
  ...
  if (getTypeID() == Float4TyID) return 1;
  if (getTypeID() == Float8TyID) return 6;
...
Type *Type::getFloat4Ty(LLVMContext &C) { return &C.pImpl->Float4Ty; }
Type *Type::getFloat8Ty(LLVMContext &C) { return &C.pImpl->Float8Ty; }
...
PointerType *Type::getFloat4PtrTy(LLVMContext &C, unsigned AS) {
  return getFloat4Ty(C)->getPointerTo(AS);
}
PointerType *Type::getFloat8PtrTy(LLVMContext &C, unsigned AS) {
  return getFloat8Ty(C)->getPointerTo(AS);
}
