...
static Type *shrinkFPConstant(ConstantFP *CFP) {
  ...
  if (fitsInFPType(CFP, APFloat::IEEEfloat4()))
    return Type::getFloat4Ty(CFP->getContext());
  if (fitsInFPType(CFP, APFloat::IEEEfloat8()))
    return Type::getFloat8Ty(CFP->getContext());
